...
An [instance](https://blyzp.github.io/admin-dashboard/) of the project [*Admin Dashboard*](https://www.theodinproject.com/lessons/node-path-intermediate-html-and-css-admin-dashboard) from the ***Full Stack JavaScript*** path of **The Odin Project**.
